...
public class AudioPickActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMaxSize = getIntent().getIntExtra(FPConstant.MAX_AUDIO_SIZE, 0);
    ...
    private void initView() {
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(FPConstant.RESULT_PICK_AUDIO, mSelectedList);
            ...
            rl_rec_aud.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Util.detectIntent(AudioPickActivity.this, intent)) {
                        startActivityForResult(intent, FPConstant.REQUEST_CODE_TAKE_AUDIO);
                    } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case FPConstant.REQUEST_CODE_TAKE_AUDIO:
