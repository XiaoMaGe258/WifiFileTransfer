...
public class ImagePickActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(FPConstant.RESULT_PICK_IMAGE, mSelectedList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case FPConstant.REQUEST_CODE_TAKE_IMAGE:
                ...
                break;
            case FPConstant.REQUEST_CODE_BROWSER_IMAGE:
                if (resultCode == RESULT_OK) {
                    ArrayList<ImageFile> list = data.getParcelableArrayListExtra(FPConstant.RESULT_BROWSER_IMAGE);
