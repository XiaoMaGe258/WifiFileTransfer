...
public class VideoPickActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMaxNumber = getIntent().getIntExtra(FPConstant.MAX_NUMBER, DEFAULT_MAX_NUMBER);
        mMaxVideoDuration = getIntent().getIntExtra(FPConstant.MAX_VIDEO_DURATION, DEFAULT_MAX_VIDEO_DURATION);
        mVideoQuality = getIntent().getIntExtra(FPConstant.VIDEO_QUALITY, 1);
    ...
    private void initView() {
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(FPConstant.RESULT_PICK_VIDEO, mSelectedList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case FPConstant.REQUEST_CODE_TAKE_VIDEO:
