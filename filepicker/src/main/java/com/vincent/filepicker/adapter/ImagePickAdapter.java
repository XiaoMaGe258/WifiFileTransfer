            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Util.detectIntent(mContext, intent)) {
                        ((Activity) mContext).startActivityForResult(intent, FPConstant.REQUEST_CODE_TAKE_IMAGE);
                    } else {
            ...
            if (isNeedImagePager) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(FPConstant.MAX_NUMBER, mMaxNumber);
                        intent.putExtra(FPConstant.DIRECTORY, selectedDirectory);
                        ...
                        ((Activity) mContext).startActivityForResult(intent, FPConstant.REQUEST_CODE_BROWSER_IMAGE);
                    }
                });
            } else {
